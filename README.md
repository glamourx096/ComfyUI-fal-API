...
This is a fork of https://github.com/gokayfem/ComfyUI-fal-API.git with the addition of some new nodes. 
...
2. Clone this repository:
   ```
   git clone https://github.com/glamourx096/ComfyUI-fal-API.git
   ```
...
- **GPT-Image 2 (fal)**: High-fidelity text-to-image generation with up to 4K resolution and transparent background support
- **GPT-Image 2 Edit (fal)**: High-fidelity image editing with up to 4K resolution (supports up to 16 batched images, optional mask, and transparent background)
- **Grok Imagine Image Edit (fal)**: Image editing using Grok Imagine (supports up to 3 images, 1K/2K resolution, optional quality model)
- **Wan 2.7 Edit (fal)**: Image editing using Wan 2.7 (supports up to 4 images, optional pro_model for higher quality)
...
- **Kling v2.1 Pro Image-to-Video (fal)**: Video Generation with Kling Pro with First Frame Last Frame support
...
- **DY Wan Upscaler (fal)**: Upscale videos using DY Wan Upscaler
...
- **Upload Video (fal)**: Upload a video to fal and get a hosted URL
- **Upload File (fal)**: Upload a local file to fal and get a hosted URL
...
If you encounter any issues or have questions, please open an issue on the [GitHub repository](https://github.com/glamourx096/ComfyUI-fal-API/issues).
